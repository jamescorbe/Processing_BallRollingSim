...
class SimObjectManager{
  ...
  ArrayList<SimSphereMover> simSphereList = new ArrayList<SimSphereMover>();
  ...
  void addSphereObject(SimSphereMover obj, String id){
    obj.setID(id);
    simSphereList.add(obj);
  }
  ...
  SimTransform getSimObject(int n){
   ...
   SimSphereMover getSimSphereObject(int n){
    return simSphereList.get(n);
  }
  ...
  int getSimSphereObjects(){
    return simSphereList.size();
  }
